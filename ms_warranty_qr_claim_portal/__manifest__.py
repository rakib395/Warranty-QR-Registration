...

{
    ...
    'data': [
        ...
        'wizard/claim_receive_wizard_view.xml',
        'wizard/warranty_reject_reason_wizard_view.xml',
        
        # Views
        'views/warranty_dashboard_view.xml',
        'views/warranty_courier_service_view.xml',
