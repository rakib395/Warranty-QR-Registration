...
class WarrantyPolicy(models.Model):
    ...
    require_reg_invoice = fields.Boolean(string='Invoice Proof Required for Registration?', default=False, tracking=True)
    require_claim_invoice = fields.Boolean(string='Invoice Proof Required for Claim?', default=False, tracking=True)
    ...
    def _onchange_parent_policy_id(self):
        if self.parent_policy_id:
            ...
            self.require_reg_invoice = parent.require_reg_invoice
            self.require_claim_invoice = parent.require_claim_invoice
